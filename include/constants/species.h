...
#define SPECIES_MEGA_MEGANIUM (SPECIES_MEGA_START + 48)
#define SPECIES_MEGA_FERALIGATR (SPECIES_MEGA_START + 49)
#define SPECIES_MEGA_FLYGON (SPECIES_MEGA_START + 50)
#define SPECIES_MEGA_BUTTERFREE (SPECIES_MEGA_START + 51)
#define SPECIES_MEGA_TYPHLOSION (SPECIES_MEGA_START + 52)

#define MAX_MEGA_NUM (SPECIES_MEGA_TYPHLOSION)
