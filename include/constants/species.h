...
#define NEW_SPECIES_START (MAX_SPECIES_INCLUDING_FORMS + 1) // 1349

#define SPECIES_MEGA_MEGANIUM (NEW_SPECIES_START)
#define SPECIES_MEGA_FERALIGATR (NEW_SPECIES_START + 1)

#define MAX_SPECIES_TOTAL (SPECIES_MEGA_FERALIGATR)
